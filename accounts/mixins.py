# -*- coding: utf-8 -*-
import json
from .models import FoodProgram, Food
...
from django.views.generic.edit import FormMixin, ProcessFormView, ProcessFormView

############################################################################################################################
### AjaxMixins

class AjaxFoodFormMixin(object):
    def form_valid(self, form):
        response = super(AjaxFoodFormMixin, self).form_valid(form)
